...
class opts(object):
    def __init__(self):
        ...
        self.parser.add_argument('task', default='ctdet',  # centernet detect
                                 help='ctdet | ddd | multi_pose | exdet')
        self.parser.add_argument('--dataset', default='coco',
                                 help='coco | kitti | coco_hp | pascal')
        self.parser.add_argument('--exp_id', default='default')  # experiment id
        self.parser.add_argument('--test', action='store_true')
        self.parser.add_argument('--debug', type=int, default=0,  # todo: whether show middle feature map
        ...
        self.parser.add_argument('--resume', action='store_true',
                                 help='resume an experiment. '
                                      ...
                                      'set load_model to model_last.pth '  # resume last model
        ...
        self.parser.add_argument('--not_cuda_benchmark', action='store_true',
                                 help='disable when the input size is not fixed.')  # multi input size, set false
        self.parser.add_argument('--seed', type=int, default=317,
                                 help='random seed')  # todo: from CornerNet
        ...
        self.parser.add_argument('--metric', default='loss',
                                 help='main metric to save best model')  # todo: metric to save best model?
        ...
        # input
        self.parser.add_argument('--input_res', type=int, default=-1,  # input height, width
        ...
        self.parser.add_argument('--rot_weight', type=float, default=1,  # rotation?
        ...
        self.parser.add_argument('--cat_spec_wh', action='store_true',  # todo: class-aware box, so many heatmaps!
    ...
    def parse(self, args=''):
        ...
        opt.test_scales = [float(i) for i in opt.test_scales.split(',')]  # default 1, not use multi

        # opposite: fix_res vs. keep_res
        ...
        # todo: opt.head_conv
        # arches, default dla_34
        # res_18 | res_101 | resdcn_18 | resdcn_101 |   # 64
        # dlav0_34 | dla_34 |   # dla, head_conv = 256
        # hourglass             # 64
    ...
    def update_dataset_info_and_set_heads(self, opt, dataset):
        ...
        opt.output_h = opt.input_h // opt.down_ratio  # default 4
        ...
        if opt.task == 'exdet':
            ...
            if opt.reg_offset:  # extremeNet, regress offset of t,l,b,r
                opt.heads.update({  # add 4 more keys
                    'reg_t': 2,
                    'reg_l': 2,
                    'reg_b': 2,
                    'reg_r': 2
                })
        elif opt.task == 'ddd':  # 3d?
            ...
            if opt.reg_bbox:  # centerNet, regress box width, height
            ...
            opt.heads = {
                ...
                'wh': 2 if not opt.cat_spec_wh else 2 * opt.num_classes  # class-agnostic or class-aware box
            }
            if opt.reg_offset:  # regress box center
                opt.heads.update({'reg': 2})
    ...
    def init(self, args=''):
        ...
        # update opt attrs by specific dataset and task!
